...
class TranscriptExtractor:
    ...
    def extract_transcript(self, video_info: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Could not retrieve transcript for video {video_id}: {e}")
            return None
    ...
    def save_transcript(self, video_info: Dict[str, Any], transcript: str, output_dir: str) -> Optional[str]:
        """
        ...
        transcript_filename = f"{self._sanitize_filename(video_title)}_{video_id}_transcript.txt"
